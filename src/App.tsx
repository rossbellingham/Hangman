...
function App() {
  ...
  return (
    <div id="hangmanDiv" style={{maxWidth: "800px", display: "flex", flexDirection: "column", gap: "2rem", margin: "0 auto", alignItems: "center"}}>
      <div id="winlossText" style={{fontSize: "2rem", textAlign: "center"}}>
